        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    formattedSigner = ethers.utils.getAddress(signer);
...
function handleOptions(request) {
    ...
    if (headers.get('Origin') !== null &&
        ...
        var respHeaders = __assign(__assign({}, corsHeaders), { 'Access-Control-Allow-Headers': request.headers.get('Access-Control-Request-Headers') });
...
export { gatherResponse, handleVerify, Router as router };
